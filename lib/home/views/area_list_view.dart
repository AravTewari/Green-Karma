...
class BadgeView extends StatefulWidget {
  const BadgeView({Key key, this.mainScreenAnimationController, this.mainScreenAnimation}) : super(key: key);
...
class _BadgeViewState extends State<BadgeView> with TickerProviderStateMixin {
